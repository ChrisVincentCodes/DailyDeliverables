$(document).ready(function() {
  ...
  $('.colorSelector').ColorPicker({
    ...
    onChange: function (hsb, hex, rgb) {
      snakeColor = '#'+hex;
      $('body').css('color', snakeColor, 'border-color', snakeColor);
      $('#score').css('color', snakeColor, 'border-color', snakeColor);
      //$('.colorSelector div').css('background-color', snakeColor);
      $('.highlight').css('background-color', '#' + hex);
    },
  ...
  function startScreen() {
    ...
    ctx.fillStyle = 'black';
    // fillRect draws a rectangle of dimensions (xi, yi, xmax, ymax) --> 0,0 is top left
    ctx.fillRect((width-100)/2, (height-40)/2, 100, 40);
    // strokeStyle accpets hex color string as input, colors stroke
    ctx.strokeStyle = snakeColor;
    // strokeRect strokes the rectangle (border) of dimensions (xi, yi, xmax, ymax) --> 0,0 is top left
    ctx.strokeRect((width-100)/2, (height-40)/2, 100, 40);
  };
